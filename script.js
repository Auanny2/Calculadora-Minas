...
let historicoDeResultado = [];//NÃO ALTERAR! variavel do array histórico
...
// Requisito 4
function sortMethod() {
  let sortCrescente = req4crescente.sort((a,b) => a-b);
  let sortDecrescente = req4decrscente.sort((a,b) => b-a);
